...
*/
	vertexShader: [
		...
		//ShaderChunksLib["envMap2"]["pars_vertex"],
		...
		"void main() {",
			...
			//ShaderChunksLib["wave"]["normal_vertex"],
...
//					THREE.ShaderChunk["default_vertex"],
			ShaderChunksLib["wave"]["vertex"],

			"vViewPosition = -mvPosition.xyz;",

			THREE.ShaderChunk["worldpos_vertex"],
			ShaderChunksLib["envMap"]["vertex"],
			//ShaderChunksLib["envMap2"]["vertex"],
	...
	fragmentShader: [
		...
		ShaderChunksLib["envMap2"]["pars_fragment"],
		...
		"void main() {",
			...
			ShaderChunksLib["envMap2"]["fragment"],
